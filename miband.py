...
class miband(Peripheral):
    ...
    def __init__(self, mac_address,key=None, timeout=0.5, debug=False):
        ...
        #self.svc_vib = self.getServiceByUUID(UUIDS.SERVICE_VIB)
    ...
    def send_alert(self, _type):
        ...
        #print(111)
        #print(UUIDS.SERVICE_VIB)
        #svc = self.getServiceByUUID(UUIDS.SERVICE_VIB)
        ...
        #text = '\x08\x01'
        #text = base_value+phone+'\x0a\x0a\x0a'+msg.replace('\\n','\n')
        char.write(bytes(str(_type),'utf-8'), withResponse=True)
